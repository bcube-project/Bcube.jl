...
@testset "Bcube.jl" begin
    ...
    custom_include("./interpolation/test_shape_function_generator.jl")
    ...
    custom_include("./assembler/test_assembler.jl")
    custom_include("./assembler/test_dirichlet.jl")
    custom_include("./assembler/test_affine_fe_system.jl")
